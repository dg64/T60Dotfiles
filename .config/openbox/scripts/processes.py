...
Usage:
    ...
    To enable cpulimit just uncomment the lines marked with (#*#) (lines 158-169).
      ...
      Spoiledbroth: Here is an updated fork of cpulimit https://github.com/torden/cpulimit

Changelog:
    28.02.18: 7th version - Openbox wiki editor added a link to an updated fork of cpulimit (untested with script)
